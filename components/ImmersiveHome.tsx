    ...
    <main className="prisme-exact-shell" aria-label="Accueil immersif Prisme">
      <div className="prisme-exact-canvas">
        ...
        <nav className="prisme-hotspots" aria-label="Navigation Prisme">
          ...
          <button className="hotspot nav-observatory" aria-label="Observatoire" onClick={() => onStart(moduleById(modules, "cognition"))} />
          <button className="hotspot nav-workshop" aria-label="Atelier" onClick={() => travel("temple", () => onStart(moduleById(modules, "personnalite")))} />
          ...
          <button className="hotspot territory-garden" aria-label="Le Jardin" onClick={() => travel("garden", () => onStart(moduleById(modules, "emotions")))} />
          <button className="hotspot territory-forest" aria-label="La Forêt" onClick={() => travel("forest", () => onStart(moduleById(modules, "quotidien")))} />
          <button className="hotspot territory-river" aria-label="Le Fleuve" onClick={() => travel("river", () => onStart(moduleById(modules, "relations")))} />
          <button className="hotspot territory-summits" aria-label="Les Sommets" onClick={() => travel("summits", () => onStart(moduleById(modules, "attention")))} />
          <button className="hotspot territory-temple" aria-label="Le Temple" onClick={() => travel("temple", () => onStart(moduleById(modules, "personnalite")))} />
          <button className="hotspot territory-sky" aria-label="Le Ciel" onClick={() => travel("sky", () => onStart(moduleById(modules, "neurodiversite")))} />
          ...
          <button className="hotspot action-meditate" aria-label="Méditer" onClick={() => travel("garden", () => onStart(moduleById(modules, "emotions")))} />
